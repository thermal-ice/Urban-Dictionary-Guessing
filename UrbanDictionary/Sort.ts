...
const sortDefinitionObjectOnVotesDiff = (defObj1: DefinitionObject, defObj2 : DefinitionObject) =>{
    ...
    const defObj1UpvoteDiff = (defObj1.thumbs_up - defObj1.thumbs_down) / defObj1.definition.length;
    const defObj2UpvoteDiff  = defObj2.thumbs_up - defObj2.thumbs_down / defObj2.definition.length;
